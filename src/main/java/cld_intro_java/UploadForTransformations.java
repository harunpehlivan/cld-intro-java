...
public class UploadForTransformations {
	public static void main(String[] args) throws IOException {
	    ...
	    //System.out.println(cloudinary.uploader().upload("./assets/blackberry.jpg",ObjectUtils.asMap("public_id","blackberry")));
	    ...
	    //System.out.println(cloudinary.uploader().upload("./assets/shirt_only.png",ObjectUtils.asMap("public_id","shirt_only")));
	    //System.out.println(cloudinary.uploader().upload("./assets/working.jpg",ObjectUtils.asMap("public_id","working")));
	    //System.out.println(cloudinary.uploader().upload("./assets/video.mp4",ObjectUtils.asMap("public_id","video","resource_type","video")));
	}
