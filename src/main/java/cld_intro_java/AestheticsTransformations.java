...
public class AestheticsTransformations {
	...
	public static void main(String[] args) throws Exception {
		...
		// Transformation().width(300).height(300).crop("thumb").gravity("auto").fetchFormat("auto").quality("auto").radius("max").background("red")).generate("face.jpg"));

		// Effects and Filters
		// color tint
		// System.out.println(cloudinary.url().transformation(new
		// Transformation().width(300).height(300).crop("thumb").gravity("face").fetchFormat("auto").quality("auto").radius("max").effect("tint:40:magenta")).generate("face.jpg"));

		// Duotone: chained transformation grayscale + tint
		// System.out.println(cloudinary.url().transformation(new
		// Transformation().width(300).height(300).crop("thumb").gravity("face").fetchFormat("auto").quality("auto").radius("max").effect("grayscale")
		// .chain().effect("tint:40:magenta").fetchFormat("auto").quality("auto")).generate("face.jpg"));
		...
		// Improve color, contrast, lightness
		// System.out.println(cloudinary.url().transformation(new
		// Transformation().width(300).height(300).crop("thumb").gravity("auto").fetchFormat("auto").quality("auto").radius("max").effect("improve:outdoor")).generate("blackberry.jpg"));

		// Art Filters
		// Zorro
		// System.out.println(cloudinary.url().transformation(new
		// Transformation().width(300).height(300).crop("thumb").gravity("auto").fetchFormat("auto").quality("auto").effect("art:zorro")).generate("lake.jpg"));

		// Cartoonify
		// System.out.println(cloudinary.url().transformation(new
		// Transformation().width(300).height(300).crop("thumb").gravity("auto").fetchFormat("auto").quality("auto").effect("cartoonify")).generate("lake.jpg"));
		...
		// .chain().overlay(new
		// TextLayer().fontFamily("Arial").text("Tutoring").fontSize(30)).background("white").color("blue").gravity("north_west").x(10).y(10)).generate("faces.jpg"));

		// Image over image
		// System.out.println(cloudinary.url().transformation(new
		// Transformation().width(300).height(300).crop("thumb")
		// .chain().overlay(new
		// Layer().publicId("logo")).height("50").gravity("south_west").x(10).y(10)).generate("faces.jpg"));

		// Text over video
		// System.out.println(cloudinary.url().resourceType("video").transformation(new
		// Transformation().width(300).crop("scale")
		// .chain().overlay(new
		// TextLayer().fontFamily("Arial").text("Earth").fontSize(30)).background("white").color("blue").gravity("north_west").x(10).y(10)).generate("video.mp4"));

		// Image over video
		// System.out.println(cloudinary.url().resourceType("video").transformation(new
		// Transformation().width(400).crop("scale")
		// .chain().overlay(new
		// Layer().publicId("logo")).height("50").gravity("north_west").x(10).y(10)).generate("video.mp4"));
	}
