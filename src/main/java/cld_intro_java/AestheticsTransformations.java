...
public class AestheticsTransformations {
	...
	public static void main(String[] args) throws Exception {
		...
		// Transformation().border("10px_solid_rgb:bde4fb").width(300).height(300).crop("thumb").gravity("auto").fetchFormat("auto").quality("auto").radius("max")).imageTag("dog.jpg"));
		...
		// System.out.println(cloudinary.url().transformation(new
		// Transformation().width(300).crop("scale").quality("auto").effect("outline:15").color("orange")).imageTag("blackberry.jpg"));
