...
<img width="800" src="./images/edit-configuration-intellij.png" alt="Edit Configuration">

**Add Environment Variables**  

<img width="800" src="./images/env-variables-intellij.png" alt="Add Environment Variables">
